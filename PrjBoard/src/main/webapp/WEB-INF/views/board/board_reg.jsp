...
document.addEventListener("DOMContentLoaded",function(){
	...
	doSaveBTN.addEventListener("click", function(e){
		...
		const boardCtgrySeq = document.querySelector("#boardCtgrySeq").value;
		const title = document.querySelector("#title").value;
		const content = document.querySelector("#content").value;
		
		console.log("memberId:"+memberId);
		console.log("boardCtgrySeq:"+boardCtgrySeq);
...
<div class="container-main">
    ...
    <div class="row justify-content-end">
        <div class="col-auto" style="margin-bottom: 10px;">
            ...
            <input type="button" value="등록" class="button" id="doSave">
        </div>
    </div>
    
    <!-- form -->
    <form action="#" name="regFrm" id="regFrm">
        <input type="hidden" name="boardCtgrySeq" id="boardCtgrySeq" value="1">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="memberId" name="memberId" value="admin" readonly="readonly">        
        </div>
        <div class="form-group">
