...
//public class QnaDaoJUnitTest implements GLog {
//	
//	@Autowired
//	QnaDao dao;
//	
...
//		
////		board01 = new QnaVO(dao.getSeq(), memberId, title+"-01", content+"-01", likeCnt, readCnt, regDt, modDt, searchKeyword);
////		board02 = new QnaVO(dao.getSeq() ,memberId, title+"-02", content+"-02", likeCnt, readCnt, regDt, modDt, searchKeyword);
////		board03 = new QnaVO(dao.getSeq(), memberId, title+"-03", content+"-03", likeCnt, readCnt, regDt, modDt, searchKeyword);
//		
//		searchVO = new QnaVO();
...
//		assertEquals(1, flag);
//		QnaVO vs01 = dao.doSelectOne(board01);
//		
...
//		assertEquals(1, flag);	
//		
//		List<QnaVO> list=dao.doRetrieve(searchVO);
//		
//		for(QnaVO vo :list) {
//			LOG.debug(vo);
//		}
...
//		
//		//3. 등록데이터 조회
//		QnaVO vo01 =dao.doSelectOne(board01);
//		
...
//		
//		//6. 수정데이터 조회
//		QnaVO vs01=dao.doSelectOne(vo01);
//		
//		//7. 비교
...
//		//3. 단건조회
//		QnaVO vo01 = dao.doSelectOne(board01);
//		QnaVO vo02 = dao.doSelectOne(board02);
//		QnaVO vo03 = dao.doSelectOne(board03);
//		
